...
#`---
#`  Title: "pubdatasets_analyze_y5k_DA_in_metrelatedKOs.R"
...
plot_dir <- paste0(published_dataset_dir,"/y5k_proteomics")
dir.create(plot_dir, recursive = T)

output_tables_dir <- paste0(published_dataset_dir,"/y5k_proteomics")
