#`---
#`  Title: "plot_bipdirnetwork_nodewise_changes_random_metal_anno.R"
#`  @author: Simran Kaur Aulakh
#`  Date created: 10 Nov 2022
#`  Description: Script to visualise flux and protein levels changes at each node distance of the control network (randomly annotated metal nodes)
#`---
...
node_dist_sig_df <- read.csv(paste0(metpert_sim_vs_exp_comparison_dir,
                                    "/metabolic_network_properties/node_distance_wise_flux_env_cell_significant_grouped_random_metal_anno.csv"),
                             stringsAsFactors = F)%>%
...
pdf(paste0(plot_dir,"/percent_fluxenvcell_ScGEM_nodedistwise_random_metal_anno.pdf"), width = 8,height = 6)
